...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/setting/allUser.php", "人员列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/setting/action/getAllUser.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/setting/action/actionUser.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/setting/allDepart.php", "机构列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/setting/action/getAllOrg.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/setting/action/actionOrg.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

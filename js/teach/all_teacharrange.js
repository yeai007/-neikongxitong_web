...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/teach/allTeachArrange.php", "教学安排列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/teach/action/getAllTeachArrange.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/teach/action/actionTeachArrange.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

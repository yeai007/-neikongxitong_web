...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/teach/allStudentWork.php", "考勤列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/teach/action/getAllStudentWork.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/teach/action/actionStudentWork.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

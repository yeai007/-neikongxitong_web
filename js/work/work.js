...
$().ready(function () {
    ...
    if ($("#pagetype").val() == "my") {
        arr_page[0] = new Array("../../modules/work/allWorkRecord.php?pagetype=my", "我的工作记录", 0, '');
    } else {
        arr_page[0] = new Array("../../modules/work/allWorkRecord.php?pagetype=all", "全部工作记录", 0, '');
    }
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/work/action/getAllWorkrecord.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/work/action/actionWorkRecord.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/cert/allCert.php", "证书列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/cert/action/getAllCert.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
//删除用户确认
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/cert/action/actionCert.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/invoice/allApplyInvoice.php", "开票信息列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/invoice/action/getAllApplyInvoice.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/invoice/action/actionApplyInvoice.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {

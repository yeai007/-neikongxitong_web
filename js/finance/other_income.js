...
$().ready(function () {
    ...
    arr_page[0] = new Array("../../modules/finance/otherInCome.php", "其他收入列表", 0, '');
    var pages = "";
...
function getList(obj) {
    $.post('../../modules/finance/action/getAllotherInCome.php', {pagetype: obj}, function (data) {
        $('#list').html(data);
    });
}
...
function deleteThis(obj) {
    if (window.confirm("你确定删除此记录吗？")) {
        $.post('../../modules/finance/action/actionOtherInCome.php', {type: "delete", id: obj}, function (data) {
            getList($("#pagetype").val());
        });
        return true;
    } else {
